/**
 *  Copyright 2017 Eric J McDonald
 *
 ...
 */
metadata {
    definition (name: "Pentair Chlorinator", namespace: "ericjmcd", author: "Eric J McDonald") {
        capability "Refresh"
        capability "Sensor"
        capability "switch"
    ...
    tiles (scale:2) {
        standardTile("chlorinate", "device.switch", width:1, height:1, inactiveLabel: false, decoration: "flat") {
            state "off",  action:"on", nextState: "updating", icon: "https://ericjmcd.github.io/SmartThings_Pentair/chlorine.png",backgroundColor: "#ffffff"
            state "on", action:"off",  nextState: "updating", icon: "https://ericjmcd.github.io/SmartThings_Pentair/chlorine.png",backgroundColor: "#00a0dc"
