/**
 *  Copyright 2017 Eric J McDonald / Kevin Chartrand
 *
 ...
 */
metadata {
    definition (name: "Pentair Intellichem", namespace: "ericjmcd", author: "Eric J McDonald") {
        capability "Refresh"
        capability "sensor"
        capability "switch"
    ...
    tiles (scale:2) {
        standardTile("chlorinate", "device.switch", width:1, height:1, inactiveLabel: false, decoration: "flat") {
            state "off",  action:"on", nextState: "updating", icon: "https://raw.githubusercontent.com/ericjmcd/SmartThings_Pentair/master/chlorine.png",backgroundColor: "#ffffff"
            state "on", action:"off",  nextState: "updating", icon: "https://raw.githubusercontent.com/ericjmcd/SmartThings_Pentair/master/chlorine.png",backgroundColor: "#00a0dc"
